var trigger = setInterval(function() {
   ...
   if (document.URL.indexOf("seniors") >= 0) {
      if (document.getElementsByClassName('sc-cMljjf bqDeCs') != undefined) {
         ...
         var infoLabel = document.getElementsByClassName('sc-cJSrbW gkRKQt'), i;
         var noSensor = document.getElementsByClassName('sc-frDJqD cpBifJ'), j;
         var insideInfoPane = document.getElementsByClassName('sc-kjoXOD duydLr');
         var innerInfo = document.getElementsByClassName('sc-ksYbfQ hgFlvp');
         ...
         var statusValueSimple = document.getElementsByClassName('sc-kgAjT SosKO');
         var statusValueEvent = document.getElementsByClassName('sc-kgAjT ilrDcI');
         var statusValueNo = document.getElementsByClassName('sc-kgAjT htnGNJ');
